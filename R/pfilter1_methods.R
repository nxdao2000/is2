## methods for the 'pfilter1d.pomp' class
...
setMethod(
    "logLik",
    signature=signature(object="pfilter1d.pomp"),
...
as.data.frame.pfilter1d.pomp <- function (x, row.names, optional, ...) as(x,"data.frame")
